...
class CmdStrokeTextEdit final : public UndoCommand
{
    public:
        ...
        void setStrokeWidthRatio(const Ratio& ratio, bool immediate) noexcept;
        void setLineSpacingFactor(const Ratio& factor, bool immediate) noexcept;
    ...
    private:
        ...
        Length mOldHeight;
        Length mNewHeight;
        Ratio mOldStrokeWidthRatio;
        Ratio mNewStrokeWidthRatio;
        Ratio mOldLineSpacingFactor;
        Ratio mNewLineSpacingFactor;
        Alignment mOldAlign;
        Alignment mNewAlign;
        bool mOldMirrored;
        bool mNewMirrored;
