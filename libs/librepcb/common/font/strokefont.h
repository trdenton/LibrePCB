...
class StrokeFont final : public QObject
{
    ...
    public:
        ...
        QVector<Path> strokeLine(const QString& text, const Length& height, Length& width) const noexcept;
        QVector<Path> strokeGlyph(const QChar& glyph, const Length& height) const noexcept;
