...
class FootprintGraphicsItem final : public QGraphicsItem
{
    public:
        ...
        QList<QSharedPointer<StrokeTextGraphicsItem>> getSelectedTexts() noexcept;
        ...
        void addText(StrokeText& text) noexcept;
        void removeText(StrokeText& text) noexcept;
    ...
    private: // Data
        ...
        QHash<const StrokeText*, QSharedPointer<StrokeTextGraphicsItem>> mTextGraphicsItems;
